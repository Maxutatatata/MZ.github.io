...
<title>MZ - Home</title>
<meta charset="utf-8">
<meta name="description" content="Сайт для MZ">
<meta name="keywords" content="Сайт для MZ">
<meta name="author" content="MZ">
<meta name="copyright" content="MZ">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>MZ - SITE<br>
							 Личный сайт нашего любимого MZ</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 На данном сайте есть вся информация про деятельность MZ, и немного больше
							</p>
							<div class='landing-btn-container'>
								<div class="build-btn-button">
									...
									<a href="https://www.youtube.com/c/MZXZM">
									<div class="build-tx1-button">
										<span>YouTube Chennels</span>
									</div>
									</a>
								</div>
							</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 У MZ есть свой личный сервер в Discord, в нем вы можете найти коды для ботов на разных языках программирывания, основной чат для общения и много чего интересного.
								</p>
							</div>
							<a href="https://discord.gg/XpZKPj6F8N" target="_blank">
